								...
								<div className='p-5'>
									...
									<div className='text-group align-self-center'>
										<h6 className='font-weight-bold pt-2'>
											Discover the business value of Synectiks Open Xformation Platform and how it
											optimizes Enterprise DevOps Strategies.{' '}
										</h6>
										<a
							...
							<div className='d-flex justify-content-around pt-2 flex-fill  align-items-center flex-col'>
								...
								<div>
									<div className='p-5'>
										...
										<div className='text-group align-self-center'>
											<h6 className='font-weight-bold pt-2'>
												Synectiks Xformation Platform accelerate any transformation project @50%
												cost &amp; Time.
											</h6>
