                    ...
                    <div className="">
                      <h3>Why DevOps Transformation matter in Today’s Business?</h3>
                        <div className="my-3 d-flex flex-row justify-content-around">
                          ...
                          <p className="">Competition, new products and continuing pressure to monetize older services severely taxing many businesses driven by legacy applications and infrastructure. To maintain competitive edge in a highly dynamic market, business need to re-imagine the customer experience in lower economics. Enterprises looking for modernization of their legacy stack and operate in more fast and competitive way taking DevOps as key strategic drivers. As companies embrace DevOps, they must address both technology and the human side of change. The most important need for technology and human side are as follows:
                          </p>
                        </div>
                        <div className="my-3 d-flex align-items-center flex-column">
                          ...
                          <p className="">
                            Small services delivered in extreme agile manner and runs in multi cloud hybrid ecosystem in lowest Capex & Opex with highest security.
                          </p>
                          </div>
...
Getting Started To DevOps
                      ...
                      <p>
                       The first step is for CIOs to connect with the business to establish clear lines of communication
and to set common goals. Within the IT organization, CIOs must set policies that identify the
need to prepare for DevOps as a priority for overall IT strategies. Courageous leadership is key for success in adopting an enterprise wide DevOps culture.
<br/>
<br/>
Then we recommend assessing the company’s People, Process and Technology estate using some standard maturity model. The Synectiks maturity model for a quick DevOps assessment is as follows:
                      ...
                      <div className='text-center '>
                        ...
                        <div className="w-75 mx-auto"><img src={six} alt="" className='boxshdd'/>
                        </div>
                        <div>
                       <h4  className='text-center my-5'>Our DevOps Gap analysis process briefly as follows:</h4>
                  ...
                  <h6 className='text-center mt-2'>Day 1<br/> Project kick-off</h6>
                  </div>
                 <h6 className='mt-4'>Initial Meetings</h6>
                 <ul className='text-left f14 pr-2'>
                 <li>Meeting with decision makers to get an insight on client pain-points and desired future-state</li>
                 <li>Kick-Off meeting with DevOps assessment stakeholders</li>
                 </ul>
                  </div>
                  ...
                  <h6 className='text-center mt-2'>Day 2 <br/>Assessment</h6>
                  </div>
                 <h6 className='mt-4'>Questions Based Audit</h6>
                 <ul className='text-left  f14'>
                 <li>A DevOps briefing for all interviews</li>
                 <li>Audit on following key focus areas:
                          </li>

                 <li>Organization</li>
                 <li>Automation</li>
                 <li>As-Is Analyzer people process Tools, Technology</li>
                 </ul>
                  </div>
                  <div  className='col-md-3 p-0 mx-3 border boxshd'>
                  ...
                  <h6 className='text-center mt-2'>Day 3 <br/>Report preparation</h6>
                  </div>
                   <h6 className='mt-4'>Report Generation</h6>
                 <ul className='text-left f14'>
                 <li>Preparation of findings report DevOps transformation plan and Roadmap</li>
                 </ul>
                  ...
                  <h6 className='text-center mt-2'>Day 4 <br/>Presentation</h6>
                  </div>
                <h6 className='mt-4'>Presentation</h6>
                 <ul className='text-left f14 pr-2'>
                 <li>Presentation of the report and plans to stakeholders, following plans are deliverd.</li> <li>Phase wise maturity development</li>
...
“Over 85% of enterprise IT organizations will commit to multi-cloud architectures by 2018, IDC. End User experience, Security, Agility, Flexibility, Consumption Based pricing are most important five priorities for CIO’s today. Synectiks is one of very few technology companies, who delivers professional services on advanced technologies backed by an open xformation platform that accelerates your DevOps transformation journey @50% time & cost.”</p>
 <div className="mx-auto">
                          {/* <img src={one} alt="" className="w-50 mx-auto" /> */}
                          </div>
<div className='d-flex flex-column align-items-center py-3'>

{/* <img src={two} alt="" className='w-100 boxshdd'/> */}
<p className='pt-4'>Synectiks build the most powerful open product that helps customers to provision resources across clouds in complete
software defined way and deliver modern container
and FAAS driven workloads on it. The platform takes care of Continuous delivery, Continuous Deployment, Continuous security and continuous compliance continuous automation
to make sure the workload runs seamlessly with highest security, performance, scalability and availability.
</p>
<p>Need?
A culture with less Roles , much E2E responsibilities
Innovate / Deliver  Fast
High Speed Feedback and Superfast Delivery
Lower Capex, Opex
<br/>
<br/>
Why Us?
Experience in addressing Technology & Cultural Changes
Accelerate DevOps adoption with Open Platform & Skilled resources.
Assess DevOps maturity  and address Gaps.

</p>
</div>
<h4 classNAme='py-4'>Cultural Transformation –</h4>
<p>Ensuring that you stay ahead of race and keep disrupting by adopting most modern technologies intelligently and effectively, requires an Open Product Based Professional Services partner who understand your requirements for:</p>
...
<p>
Our discovery and assessment services can help you draft a DevOps roadmap with a clearly defined business case and mapping of peoples / process / technologies along with prioritized recommendations. Our recommendations reflect deep industry knowledge and contextual knowledge about your business.</p>
</div>
<div className='d-flex align-items-center'>
<img src={five}className="w9 mr-5" />
<p>You can access our open Xformation platform products and resource teams to adopt technology and cultural changes quickly — from Application modernization, people skill and process transformation and integration to cloud-native apps development, containerization, platform services and microservices — to enable your enterprise to thrive in Hybrid IT environments. </p>
</div>
</div>
                  ...
                  <TabPane tabId="4">
                      <div>
                        ...
                        <h4 className='text-center my-5'>
                          Top 8 Reasons to select Synectiks as your Hybrid
                          Cloud Partner:
                        </h4>
                      </div>
                      ...
                      <div className="my-4">
                        ...
                        <div className="col-sm-4 col-md-4 text-center d-flex align-items-center flex-column">
                          ...
                          <div className="col-sm-4 col-md-4 text-center d-flex align-items-center flex-column">
                            ...
                            <p> We have done large Transformation projects with Toyota, Relianace and cultural challenges effectively and brought the changes, resulting significant improvement and savings.</p>
                          </div>
                          ...
                          <div className="col-sm-4 col-md-4 text-center d-flex align-items-center flex-column">
                            ...
                            <p>
                              {" "}
                              We are continuously contributing open XFormation platform that is accelerating the transformation @50% Time & Cost.
                            </p>
                          </div>
                        </div>
                      </div>
...
<h5>Faster Delivery</h5></div>
<p className='ml-3 mb-4'>Synectiks xformation platform enabled infrastructure and application provisioning in complete software defined manner with regulatory compliant architectures. The existing assets and best practices enable project delivery in weeks than months.</p></div>
<div className='d-flex justify-content-around align-items-end my-4'>
<div  className='d-flex flex-column align-items-center'>
<img src={betterQual} alt='better quality' className='w-37' />
<h5>Better Quality</h5></div>
<p className='ml-3 mb-4'>Through Synectiks Xformation platform, you can continuously deliver containerized and serverless microservices verified through stringent quality gates that run across clouds and geographies ensuring 100% availability and maximum performance.</p></div>
<div className='d-flex justify-content-around align-items-center my-4'>
<div  className='d-flex flex-column align-items-center'>
<img src={lowCost} alt='low cost' className='w-50' />
<h5>Lower Costs</h5></div>
<p className='ml-5'>Everything software defined and maximum automation ensure lowest TCO. A successful Digital Modernization project delivers 10X agility,30X reliability and 10X operational efficiency. At least 50 % TCO is reduced because of 80% operation,
50% hardware and 100% license cost savings.
<br/>
Now is the time to act. Don’t be disrupted — be the disruptor. Let us help you innovate and transform to differentiate with speed and quality. That’s Synectiks. That’s transformation Delivered in open product based solutioning model.</p></div>
 </div>
                  </TabPane>
                </TabContent>
              </div>
