     ...
     <Row className='position-relative'>
      <div className='col-sm-12 col-md-12'>
        ...
        <Collapse isOpen={!collapsed} navbar="navbar">
         <Nav className='bgWhite d-flex my-2 my-md-4 mx-auto w-85'>
          <NavItem className='one'>
           <NavLink id='bgL' className={classnames({
             active: activeTab === '1'
            })} onClick={() => {
             toggle('1');
             toggleTab();
          ...
          <NavItem className='one'>
           <NavLink id='bgLL' className={classnames({
             active: activeTab === '2'
            })} onClick={() => {
             toggle('2');
             toggleTab();
          ...
          <NavItem className='one'>
           <NavLink id='bgLLL' className={classnames({
             active: activeTab === '3'
            })} onClick={() => {
             toggle('3');
             toggleTab();
       ...
       <TabContent activeTab={activeTab}>
        <TabPane tabId='1'>
         <div>
          <div className='w-100 d-flex flex-column flex-md-row align-items-start py-2 py-md-3'>
           ...
           <img className='microImage imgshadow' height='auto' src={ms1} alt='Microservices'/>
          </div>
         ...
         <div className='d-flex flex-column flex-md-row	justify-content-between text-light'>
          ...
          <div className='bgBlue w-100 p-3  p-md-3'>
           <ul>
            ...
            <li>
             Duplication of processes and tools</li>
            <li>
             Complexity moves from components to interactions</li>
            <li>
             Debugging across components</li>
            <li>
             Deployment</li>
           </ul>
          </div>
         </div>
         <p className='my-0 mt-md-4 pt-md-2'>Thankfully, current cloud-based distributed technologies alleviate the burden of managing monolithic applications by providing a platform to develop and deploy on a dime.</p>
         <div className='my-0 my-md-4	'>
          ...
          <div className='d-flex flex-column align-items-start flex-md-row justify-md-between  px-2 px-md-0 mt-2 mt-md-5'>
           <div className='pr-0 pr-md-5 w-100'>
            ...
            <p>
             An ideal microservices hosting platform is based on geographically spanned cluster and hardware agnostic. While this platform alleviates the burden of managing many servers, operating systems etc., it brings a new set of operational challenges like debugging, logs tracing, many processes and tools running for single application. The operation management paradigm is shifted from managing Compute/Network/Storage and operating system to managing geographically distributed clusters and services management, their interaction. Thankfully, current cloud-based service discovery and cluster wide operation management technologies offer avenues to aggregate those operational challenges.</p>
            <p>Essentially in a microservices ecosystem, you will aggregate, extent & automate. You will aggregate your hardware across DC’s and geographies, develop microservices, bigdata, IOT applications based on libraries and reusable services and continue to do cluster and services automation toward running everything in auto pilot mode.</p>
           </div>
           <div className='w-100'><img src={ms4} className='w-100 imgshadow'/></div>
          </div>
        ...
        <TabPane tabId='4'>
         <div>
          <p>SYNECTIKS, a trusted partner with experience migrating monolithic applications to cloud and microservices architecture, can help make the process seamless. Let us help you make the shift so you can capitalize on business opportunities faster.
           <br/>SYNECTIKS has a flexible and effective way of migrating monolithic applications to microservices, which includes the following steps:</p>
         ...
         <div>
          <div className='d-flex flex-column flex-md-row justify-content-between my-0 my-md-5'>
           <div className="bgOrange text-light w-100 p-2 p-md-3">
            <h3>Discovery and Assessment.
            </h3>
            <ul>
             <li>Meet with the Stakeholders, Infrastructure and Application SME’s to gather detailed information about the applications and databases.</li>
            </ul>
           </div>
           <div className="bgRed text-light w-100 mx-0 mx-md-3 p-2 p-md-3">
            <h3>Business Readiness.
            </h3>
            <ul>
          ...
          <ul>
           ...
           <li>
            Create Migration RoadMap.</li>
           <li>Create Risk Plan.</li>
           <li>Create Target Architectures
           </li>
           <li>Create a project plan and share with all the stakeholders.
           </li>
           <li>Split the application into smaller domains.
           </li>
           <li>Define the boundaries of the domains and microservices.
           </li>
           <li>Finalize the technology stack.</li>
           <li>
            Generate infrastructure blueprints.</li>
           <li>
            Set up the foundation environment Put Continuous Integration/Continuous Delivery (CI/CD) pipelines in place.</li>
           <li>
            Begin development sprints (SYNECTIKS prefers test-driven development to minimize manual testing).</li>
           <li>Help to use SYNECTIKS Application blocks / libraries to do rapid transformation.</li>
          </ul>
          <div>
           <p>SYNECTIKS is committed to working with its customers to meet almost any need.</p>
           <ul>
            <li>Adapt DevOps culture across organization, essential for developing microservices, foster small, independent teams within the organization to take over ownership of the services.</li>
            <li>Transform your hardware driven infrastructure to a complete multi-cloud hybrid software driven system</li>
            <li>Streamline communications to ensure success</li>
            <li>Embrace CI best practices and automate CI/CD processes</li>
            <li>Embrace operation automations to manage distributed cluster and services With SYNECTIKS Xformation platform, companies can take advantage of an API driven cloud architecture and get going faster.</li>
           </ul>
           <div>
            <img src={ms9} alt="" className='my-0 my-md-4 microImage imgshadow'/>
           </div>
           <div>
            <p>How much effort it takes to perform a Monolith to Microservices transformation?</p>
            <p>
             Though it depends on complexity & sizing of the existing applications, you could accelerate the transformation process by engaging a microservices SYNECTIKS who can help you as follows:</p>
            <ul>
             ...
             <li>
              Embrace DevOps centric culture by delivering you skilled DevOps resources.</li>
            </ul>
            <div className='my-0 my-md-5'>
             <h3>Why SYNECTIKS should be your trusted microservice partner?</h3>
             <img src={ms8} alt="" className='my-0 mt-md-4 microImage imgshadow'/></div>
           </div>
          </div>
         </div>
        </TabPane>
