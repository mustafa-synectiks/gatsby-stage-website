			...
			<Layout>
				...
				<div className='bg-lightgrey'>
					...
					<div class='container'>
						...
						<div
							className=' text-black w-100 mt-3 text-white px-5 pb-2 pt-5 flex-col d-flex text-justify'
							data-aos='fade-up'
							data-aos-duration='2000'>
							<div className='w-100  text-black'>
								<p className='lineHeight-24'>
									Microsoft is the recognized leader in cloud productivity solutions for business with
									Office 365 - transforming the workplace experience.
								</p>
								<p className='lineHeight-24'>
									With a certified team of Microsoft Partner Professionals, SYNECTIKS delivers on all
									Microsoft Cloud Solutions, including Office 365, SharePoint, Skype for Business,
									Teams, Power BI, Microsoft 365 (Office 365 + Enterprise Mobility + Security) and
									Azure.
									<br />
								</p>
								<p className='lineHeight-24'>
								...
								<p className='lineHeight-24'>
									...
									provide a holistic set of transformational and managed services to modernize your
									workplace.
									<br />
								</p>
								<p className='lineHeight-24'>
									...
									<ul className='lineHeight-34'>
										...
										<li>
											Insights from self-service and data discovery with Microsoft Power BI for
											Office 365.
										</li>
										<li>
						...
						<div
							...
							<div className='p-3 m-1 col-sm-3 border-grey-2px text-center'>
								<div className='w-100 '>
									...
									<p>
										Work Anywhere, Anytime, on Any Device with Office 365. Empower your employees
										the tools they need.
									</p>
								</div>
							</div>
							...
							<div className='p-3 m-1 col-sm-3 border-grey-2px text-center'>
								<div className='w-100 '>
									...
									<p>Enjoy access to the latest versions, security updates and feature releases.</p>
								</div>
							</div>
								...
								<p className='lineHeight-24 '>
									...
									<ul className='lineHeight-34'>
										<li>
											...
											response time on Sev-1 tickets. SLA based proactive support with Microsoft
											support escalations.
										</li>
										<li>
											<b>Migration Assistance:</b> Let our dedicated team of specialists help you
											plan and perform your email data migration.
										</li>
										<li>
											<b>Dedicated to Your Success:</b> It’s our mission to enable your continued
											success by advising you and your team on the right technologies &amp; tools
